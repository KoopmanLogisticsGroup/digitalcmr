...
CHANNEL_NAME="kpmallstagchannel" PEER_MSPID="allMSP" PEER_ADDRESS="peer0-all:5010" ORDERER_ADDRESS="149.81.124.82:31010" MSP_CONFIGPATH="/fabric-config/Admin@all/msp" create/join_channel.sh
...
ORDERER_ADDRESS="149.81.124.82:31010" create/create_composer.sh
