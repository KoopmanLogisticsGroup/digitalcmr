...
GENESIS="trial" create/recover_blockchain.sh
...
CHANNEL_FILE="trial" GENESIS="trial" create/create_cryptos.sh

echo ""
echo "=> CREATE_ALL: Running Create Channel"
CHANNEL_FILE="trial" PEER_MSPID="kpm-allMSP" CHANNEL_NAME="kpmalliancetrialchannel" ORDERER_ADDRESS="orderer-kpm-all:7050" create/create_channel.sh

echo ""
echo "=> CREATE_ALL: Running Join Channel on kpm-all Peer1"
CHANNEL_NAME="kpmalliancetrialchannel" PEER_MSPID="kpm-allMSP" PEER_ADDRESS="peer0-kpm-all:5010" ORDERER_ADDRESS="orderer-kpm-all:7050" MSP_CONFIGPATH="/fabric-config/Admin@kpm-all/msp" create/join_channel.sh
