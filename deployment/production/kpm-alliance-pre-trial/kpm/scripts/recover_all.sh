...
GENESIS="pre-trial" create/recover_blockchain.sh
...
CHANNEL_FILE="pre-trial" GENESIS="pre-trial" create/create_cryptos.sh

echo ""
echo "=> CREATE_ALL: Running Create Channel"
CHANNEL_FILE="pre-trial" PEER_MSPID="kpm-allMSP" CHANNEL_NAME="kpmalliancepretrialchannel" ORDERER_ADDRESS="orderer-kpm-all:7050" create/create_channel.sh

echo ""
echo "=> CREATE_ALL: Running Join Channel on kpm-all Peer1"
CHANNEL_NAME="kpmalliancepretrialchannel" PEER_MSPID="kpm-allMSP" PEER_ADDRESS="peer0-kpm-all:5010" ORDERER_ADDRESS="orderer-kpm-all:7050" MSP_CONFIGPATH="/fabric-config/Admin@kpm-all/msp" create/join_channel.sh
