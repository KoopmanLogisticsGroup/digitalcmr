...
if [ -z "${PEER_ADDRESS}" ]; then
	echo "PEER_ADDRESS not defined. I will use \"blockchain-kpm-ponpeer1:5010\"."
	echo "I will wait 5 seconds before continuing."
	sleep 5
fi
PEER_ADDRESS=${PEER_ADDRESS:-blockchain-kpm-ponpeer1:5010}
...
if [ -z "${MSP_CONFIGPATH}" ]; then
	echo "MSP_CONFIGPATH not defined. I will use \"/shared/crypto-config/peerOrganizations/kpm-pon.example.com/users/Admin@kpm-pon.example.com/msp\"."
	echo "I will wait 5 seconds before continuing."
	sleep 5
fi
