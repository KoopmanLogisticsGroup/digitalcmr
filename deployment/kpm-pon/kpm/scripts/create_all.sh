...
CHANNEL_NAME="composerchannel" PEER_MSPID="kpm-ponMSP" PEER_ADDRESS="peer0-kpm-pon:5010" MSP_CONFIGPATH="/fabric-config/Admin@kpm-pon/msp" create/join_channel.sh
