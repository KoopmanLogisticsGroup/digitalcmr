...
function buildECMR(ecmrID) {
    ...
    ecmr.source = factory.newRelationship(namespace, 'CompoundOrg', 'source');
...
return adminConnection.createProfile(connectionProfile, {type: 'embedded'})
            .then(() => {
                ...
                // runtime.
    return adminConnection.connect(connectionProfile, 'admin', 'adminpw');
            })
            .then(() => {
...
return businessNetworkConnection.connect(connectionProfile, networkName, 'admin', 'adminpw');
            })
            .then(() => {
    // Get the factory for the business network
    factory = businessNetworkConnection.getBusinessNetwork().getFactory();
// Create the LegalOwnerOrg
factory.newResource(namespace, 'LegalOwnerOrg', 'leaseplan');
