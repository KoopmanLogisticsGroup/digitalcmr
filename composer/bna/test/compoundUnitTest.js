    ...
    beforeEach(() => {
      ...
      return adminConnection.createProfile(connectionProfile, {type: 'embedded'})
        ...
        .then(() => {
          ...
          const legalOwnerAdmin = factory.newResource(namespace, 'CompoundAdmin', 'lapo@leaseplan.org');
          ...
          legalOwnerAdmin.org = factory.newRelationship(namespace, 'CompoundOrg', 'amsterdamcompound');
        ...
        .then(() => {
          ...
          return businessNetworkConnection.issueIdentity('org.digitalcmr.CompoundAdmin#amsterdamcompound', 'willem@amsterdamcompound.org')
            .then((identity) => {
